(function ($) {
    ...
    var methods =
    {
        init: function (options) {
            opts = $.extend({
                addCss: true, //if set to false you have to add 'display:block;position:absolute;' to the css of the moving object
                maxHeight: $(document).height(), // (window.innerHeight - 50), //height bound for moving
                maxWidth: (window.innerWidth - 50), //width bound for moving
                minDuration: 24000, //minimun length of animation
